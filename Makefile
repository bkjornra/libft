...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/02/11 15:37:04 by bkjornra          #+#    #+#              #
#    Updated: 2019/03/01 03:37:58 by bkjornra         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FUNCTIONS = ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c ft_memcmp.c \
			...
			ft_lstiter.c ft_lstmap.c ft_digit_len.c ft_whitespace.c ft_count_words.c

OBJECTS = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o ft_memchr.o ft_memcmp.o \
		  ft_strlen.o ft_strdup.o ft_strcpy.o ft_strncpy.o ft_strcat.o ft_strncat.o ft_strlcat.o \
		  ft_strchr.o ft_strrchr.o ft_strstr.o ft_strnstr.o ft_strcmp.o ft_strncmp.o ft_atoi.o \
		  ...
		  ft_lstiter.o ft_lstmap.o ft_digit_len.o ft_whitespace.o ft_count_words.o

all: $(NAME)

$(NAME):
	gcc -c $(FUNCTIONS) $(FLAGS) -I.$(HEADER)
	ar rc $(NAME) $(OBJECTS)
	ranlib $(NAME)
